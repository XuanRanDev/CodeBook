...
public class PasswordCipherStrategy implements CipherStrategy {
    ...
    @NonNull
    private String decryptingData(String encryptedData) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidAlgorithmParameterException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException {
